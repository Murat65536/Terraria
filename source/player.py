...
class Player:
            ...
            if self.hp > 0:  # check if the    player has died    from damage
                ...
                if commons.PARTICLES:
                    ...
                    for    i in range(int(10 *    commons.PARTICLE_DENSITY)):    # blood
                        ...
                        entity_manager.spawn_particle(particle_pos,    pygame.Color(230, 0, 0), life=1, size=10, angle=velocity_angle,    spread=math.pi * 0.2, magnitude=random.random()    * velocity_magnitude, gravity=0.15,    outline=True)
            else:
    ...
    def    kill(self, source, source_velocity=None):
        if self.alive:
            ...
            entity_manager.add_message(get_death_message(self.name,    source), (255, 0, 0))
            ...
            if commons.PARTICLES:
                ...
                for    i in range(int(35 *    commons.PARTICLE_DENSITY)):    # more blood
                    entity_manager.spawn_particle((self.position[0]    + random.random() *    commons.PLAYER_WIDTH - commons.PLAYER_WIDTH    * 0.5,
                                                  ...
                                                  pygame.Color(230,    0, 0), life=1, angle=velocity_angle, size=10, spread=0.9,
